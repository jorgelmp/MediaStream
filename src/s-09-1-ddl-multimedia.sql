...
LOB (PORTADA) STORE AS ALBUM_PORTADA_LOB (
  ...
  INDEX ALBUM_PORTADA_LOBIC (TABLESPACE MEDIA_INDICES_TBS)
)
...
LOB (FRAGMENTO_VIDEO) STORE AS SECCION_VIDEO_FRAGMENTO_VIDEO_FK (
  TABLESPACE  MEDIA_CONTENIDOS_TBS
  INDEX       (TABLESPACE MEDIA_CONTENIDOS_TBS)
)
TABLESPACE MEDIA_DATOS_TBS
;
